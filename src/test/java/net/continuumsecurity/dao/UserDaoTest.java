package net.continuumsecurity.dao;

import net.continuumsecurity.Constants;
import net.continuumsecurity.model.Address;
...
public class UserDaoTest extends BaseDaoTestCase {
    ...
    public void testUserSearch() throws Exception {
        ...
        // test mirroring
        user = dao.get(-2L);
        user.setFirstName("AdminX");
        dao.saveUser(user);
        flush();

        // now verify it is reflected in the index
        found = dao.search("AdminX");
        assertEquals(1, found.size());
        user = found.get(0);
        assertEquals("AdminX", user.getFirstName());
        */
    }
}
